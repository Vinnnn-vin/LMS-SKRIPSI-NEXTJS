...
export default async function AdminDashboardPage() {
    ...
    const stats = [
        { title: 'Total User', value: formatNumber(statsResult.data.totalUsers), icon: IconUsers, color: 'blue' },
        { title: 'Total Kursus', value: formatNumber(statsResult.data.totalCourses), icon: IconBook, color: 'violet' },
        { title: 'Total Penjualan', value: formatRupiah(statsResult.data.totalSales), icon: IconCash, color: 'green' },
        { title: 'Total Pendaftaran', value: formatNumber(statsResult.data.totalEnrollments), icon: IconCertificate, color: 'orange' },
    ];
        ...
        <Container fluid>
            ...
            <SimpleGrid cols={{ base: 1, lg: 2 }} mt="xl">
                ...
                <Paper withBorder p="lg" radius="md">
                    ...
                    <Text c="dimmed" size="sm" mt="md">Grafik dan statistik tambahan akan ditampilkan di sini.</Text>
                </Paper>
            </SimpleGrid>
        </Container>
    );
