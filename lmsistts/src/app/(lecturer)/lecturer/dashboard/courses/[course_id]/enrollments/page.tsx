...
export default async function LecturerCourseEnrollmentsPage({
  params,
}: {
  ...
  const items = [
    ...
    {
      title: courseResult.data?.course_title || "Detail Kursus",
      href: `/lecturer/dashboard/courses/${courseId}/enrollments`,
    },
  ].map((item, index) => (
  ...
  return (
    <Container fluid>
      ...
      <Text c="dimmed" mb="lg">
        Lihat progres mahasiswa di kursus "{courseResult.data?.course_title}".
      </Text>
