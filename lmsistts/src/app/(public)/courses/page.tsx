      ...
      <CardSection className={classes.imageSection}>
        ...
        >
          <Overlay
            ...
            opacity={0.8}
          />
          <Badge size="lg" variant="filled" className={classes.categoryBadge}>
        ...
        <Box>
          ...
          <Text size="sm" c="dimmed" lineClamp={2} mt={4}>
            {course.course_description ||
              "Kursus premium dengan materi terupdate dan instruktur berpengalaman."}
          </Text>
        </Box>
        ...
        <Center py={80}>
          <Stack gap="xl" align="center" maw={800}>
            ...
            <Title order={1} ta="center" className={classes.heroTitle}>
              Temukan{" "}
              <span className={classes.gradientText}>Kursus Perfect</span> untuk
              Anda
            </Title>
            <Text ta="center" c="dimmed" size="xl">
              Jelajahi berbagai kursus berkualitas dari instruktur ahli dan
...
export default function CoursesPage() {
  ...
  const filteredCourses = useMemo(() => {
    ...
    if (categoryValue) {
      filtered = filtered.filter(
        (course) => course.category.category_name === categoryValue
      );
    }
  ...
  const activeFiltersCount = [searchValue, categoryValue].filter(
    Boolean
  ).length;
