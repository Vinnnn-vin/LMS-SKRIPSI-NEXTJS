...
export default async function CoursesPage() {
  const { success, data: courses, error } = await getAllCourses();
  ...
  return (
    <Container py="xl">
      ...
      <Text c="dimmed" ta="center" size="lg" mb="xl">
        Temukan kursus yang tepat untuk perjalanan belajar Anda berikutnya.
      </Text>
      ...
      {success && courses && courses.length > 0 ? (
        <SimpleGrid cols={{ base: 1, sm: 2, md: 3, lg: 4 }} spacing="lg" verticalSpacing="xl">
